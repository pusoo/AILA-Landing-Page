      ...
      <div className="flex flex-col sm:grid sm:grid-cols-3 gap-x-9 gap-y-9 sm:gap-y-0 mt-5">
        ...
        <div className="flex flex-col gap-9">
          <div className="flex flex-col justify-center items-center gap-3">
            ...
            <p className="feature-title text-lg w-full sm:text-2xl">Upload Media</p>
            <p>
          ...
          <div className="flex flex-col justify-center items-center gap-3">
            ...
            <p className="feature-title text-lg w-full sm:text-2xl">Chatbot Interaction</p>
        ...
        <div className="flex flex-col justify-center items-center text-center gap-3 sm:text-left sm:items-start">
          ...
          <p className="feature-title text-lg w-full sm:text-2xl">Generate Summaries</p>
